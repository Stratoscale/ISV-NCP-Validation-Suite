#!/usr/bin/env python3
"""Describe a zcompute bare-metal instance.

Same as scripts/vm/describe_instance.py, with platform="bm". This is the
step validations (SSH, GPU, host OS) bind to — it runs in the test phase
so those checks see the current IP after stop/start/reboot/power-cycle.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Describe a zcompute bare-metal instance")
